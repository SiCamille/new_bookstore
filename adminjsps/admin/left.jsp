...
var bar1 = new Q6MenuBar("bar1", "猫的天空之城");
function load() {
	bar1.colorStyle = 2;
	bar1.config.imgDir = "<c:url value='/menu/img/'/>";
	bar1.config.radioButton=false;
	bar1.add("分类管理", "查看分类", "<c:url value='/adminCategoryServlet?method=list'/>", "body");
	bar1.add("分类管理", "添加分类", "<c:url value='/adminjsps/admin/category/add.jsp'/>", "body");

	bar1.add("图书管理", "查看图书", "<c:url value='/adminBookServlet?method=list'/>", "body");
...
<body onload="load()" style="margin: 0px;color: #2e4c8c; ">
<div id="menu"></div>
